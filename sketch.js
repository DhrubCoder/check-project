...
function preload() {
  ...
  sShip = loadAnimation("assets/plane.png");
...
function setup() {
  ...
  enemy2 = createSprite(1400 , 500 , 60 , 60);
  enemy2.addImage(enemy1);
  enemy2.scale = 3;
  enemy2.velocityX = -13

  enemy3 = createSprite(1550 , 500 , 60 , 60);
  enemy3.addImage(enemy1);
  enemy3.scale = 3;
  enemy3.velocityX = -10

  enemy4 = createSprite(1250 , 500 , 60 , 60);
  enemy4.addImage("enemy123",enemy1);
  enemy4.scale = 3;
  enemy4.velocityX = -1
...
function draw() {
  ...
  if (keyWentUp(RIGHT_ARROW)) {
    ...
    if(bulletGroup.isTouching(enemy4)){
      enemy4.addImage("enemy123",sShip)
      enemy4.scale=0.8;
      //comment the below line if you want to keep moving 
      enemy4.velocityX=0
      bulletGroup.destroyEach();
 ...
 if( enemy.isTouching( manStand) ) {
   ...
   if( enemy5.isTouching( manStand) ) {
    ...
    if( enemy11.isTouching( manStand) ) {
      ...
      manStand.destroy(); bulletGroup.destroyEach();
      bulletGroup.destroyEach();
    }
...
/* function createPlane(){
  sShipImg = createSprite(310 , 520 , 60 , 60) ;
  sShipImg.addImage(sShip);
  sShipImg.scale =0.09;
 // sShip.velocityX = -20;
}
*/